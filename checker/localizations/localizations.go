...
// 2023-04-24 14:24:48.498648 +0100 IST m=+0.002615710
...
var localizations = map[string]string{
	...
	"en.messages.api-path-added":                                           "api path added",
	"en.messages.api-path-deprecated":                                      "api path deprecated",
	"en.messages.api-path-reactivated":                                     "api path reactivated",
	...
	"ru.messages.api-deprecated-sunset-parse":                              "API deprecated без валидно парсящейся даты sunset",
